...
import UpdateComponente from "../controllers/updateComponente";

export default class FormUpdateHeader extends Form {
    app: App;
    model: ComponenteTemplate;
    lista: any;
    constructor(app: App, model: ComponenteTemplate, lista: any) {
        super(model, "Criando componente Cabecalho", new UpdateComponente(app), { back: "none", next: "Atualizar" })
        this.app = app
        this.model = model
        this.lista = lista
    }
